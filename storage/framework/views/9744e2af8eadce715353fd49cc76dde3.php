...
<?php $__env->startSection('title', 'หน้าหลัก | Dashboard'); ?>
...
<div class="apple-dashboard">
    ...
    <div class="apple-hero animate-in">
        ...
        <div class="hero-actions">
            <a href="<?php echo e(route('projects.my')); ?>" class="apple-btn apple-btn-primary">
                <i class="bi bi-journal-text"></i>
                โครงงานของฉัน
            </a>
            <a href="<?php echo e(route('projects.index')); ?>" class="apple-btn apple-btn-secondary">
        ...
        <div class="hero-stats">
            <div class="hero-stat">
                <div class="hero-stat-number"><?php echo e(number_format($stats['totalAlumni'] ?? 0)); ?></div>
                <div class="hero-stat-label">ศิษย์เก่าทั้งหมด</div>
            </div>
            <div class="hero-stat">
                <div class="hero-stat-number"><?php echo e(number_format($stats['totalProjects'] ?? 0)); ?></div>
                <div class="hero-stat-label">โครงงานนักศึกษา</div>
            </div>
            <div class="hero-stat">
                <div class="hero-stat-number"><?php echo e($stats['graduationYears'] ?? 0); ?></div>
                <div class="hero-stat-label">รุ่นที่จบการศึกษา</div>
            </div>
            <div class="hero-stat">
                <div class="hero-stat-number"><?php echo e($stats['employmentRate'] ?? 0); ?>%</div>
    ...
    <div class="stats-grid">
        <div class="apple-stat-card animate-in delay-1">
            ...
            <div class="stat-value"><?php echo e(number_format($stats['totalAlumni'] ?? 0)); ?></div>
        ...
        <div class="apple-stat-card animate-in delay-2">
            ...
            <div class="stat-value"><?php echo e(number_format($stats['employedAlumni'] ?? 0)); ?></div>
            <div class="stat-label">ศิษย์เก่ามีงานทำ</div>
            <div class="stat-change positive">
                <i class="bi bi-arrow-up"></i> <?php echo e($stats['employmentRate'] ?? 0); ?>%
            </div>
        </div>
        <div class="apple-stat-card animate-in delay-3">
            ...
            <div class="stat-value"><?php echo e(number_format($stats['totalProjects'] ?? 0)); ?></div>
            <div class="stat-label">โครงงานทั้งหมด</div>
            <div class="stat-change positive">
                <i class="bi bi-check-circle"></i> <?php echo e($stats['completedProjects'] ?? 0); ?> เสร็จสิ้น
            </div>
        </div>
        <div class="apple-stat-card animate-in delay-4">
            ...
            <div class="stat-value"><?php echo e(number_format($stats['selfEmployedAlumni'] ?? 0)); ?></div>
    ...
    <div class="alumni-section">
        ...
        <div class="alumni-grid">
            <?php $__empty_1 = true; $__currentLoopData = $featuredAlumni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $alumni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            ?>
            <div class="alumni-card animate-in delay-<?php echo e($index + 1); ?>">
                <div class="alumni-card-header <?php echo e($gradient); ?>">
                    <span class="alumni-badge">⭐ รุ่น <?php echo e($alumni->graduation_year); ?></span>
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($alumni->first_name . ' ' . $alumni->last_name)); ?>&background=<?php echo e($color); ?>&color=fff&size=200" alt="Alumni" class="alumni-avatar">
                </div>
                <div class="alumni-card-body">
                    <h5 class="alumni-name"><?php echo e($alumni->prefix); ?><?php echo e($alumni->first_name); ?> <?php echo e($alumni->last_name); ?></h5>
                    <p class="alumni-batch">รุ่นปี พ.ศ. <?php echo e($alumni->graduation_year); ?></p>
                    <p class="alumni-position"><?php echo e($alumni->current_position ?? '-'); ?></p>
                    <span class="alumni-company">
                        <i class="bi bi-building"></i>
                        <?php echo e($alumni->current_workplace ?? '-'); ?>
    ...
    <div class="stories-section">
        ...
        <div class="stories-container">
            <?php $__empty_1 = true; $__currentLoopData = $latestProjects->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
                $statusColors = [
            ...
            ?>
            <div class="story-card <?php echo e($index === 0 ? 'featured' : ''); ?> animate-in delay-<?php echo e($index + 1); ?>">
                <span class="story-quote">📁</span>
                <div class="story-author">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($project->project_code)); ?>&background=<?php echo e($index === 0 ? '667eea' : '4facfe'); ?>&color=fff&size=100" alt="Project">
                    <div class="story-author-info">
                        <h6><?php echo e($project->project_code); ?></h6>
                        <span><?php echo e($project->category); ?> | ปี <?php echo e($project->academic_year); ?></span>
                    </div>
                </div>
                <h5 class="story-title"><?php echo e($project->title); ?></h5>
                <p class="story-excerpt">
                    <?php echo e(Str::limit($project->description ?? 'ไม่มีรายละเอียด', 150)); ?>

                    <?php if($project->advisor): ?>
                    <br><strong>อาจารย์ที่ปรึกษา:</strong> <?php echo e($project->advisor); ?>

                    <?php endif; ?>
                </p>
                <div class="story-meta">
                    <span class="story-tag" style="background: <?php echo e($statusColors[$project->status] ?? 'var(--apple-blue)'); ?>"><?php echo e($statusLabels[$project->status] ?? $project->status); ?></span>
                    <?php if($project->score): ?>
                    <span><i class="bi bi-star-fill" style="color: gold;"></i> <?php echo e($project->score); ?> คะแนน</span>
                    <?php endif; ?>
                    <?php if(count($members ?? []) > 0): ?>
                    <span><i class="bi bi-people"></i> <?php echo e(count($members)); ?> คน</span>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="quick-actions animate-in">
        <a href="<?php echo e(route('students.index')); ?>" class="apple-btn apple-btn-primary">
            <i class="bi bi-people-fill"></i>
            จัดการนักศึกษา
        </a>
        <a href="<?php echo e(route('alumni.index')); ?>" class="apple-btn apple-btn-secondary">
        ...
        <a href="<?php echo e(route('reports.myStudent')); ?>" class="apple-btn apple-btn-secondary">
            <i class="bi bi-person-check"></i>
            รายงานของฉัน
        </a>
        <a href="<?php echo e(route('reports.internships')); ?>" class="apple-btn apple-btn-secondary">
    ...
    <div class="announcement-list animate-in">
        ...
        <div class="announcement-item">
            <div class="announcement-icon" style="background: <?php echo e($announcement->color ?? 'var(--apple-gradient-1)'); ?>;">
                <i class="bi <?php echo e($announcement->icon ?? 'bi-megaphone'); ?>"></i>
            </div>
            <div class="announcement-content">
                <h6><?php echo e($announcement->title); ?></h6>
                <p><?php echo e(Str::limit($announcement->content, 150)); ?></p>
                <span class="announcement-date"><i class="bi bi-clock"></i> <?php echo e($announcement->time_ago); ?></span>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="announcement-item">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/student/resources/views/home.blade.php ENDPATH**/ ?>