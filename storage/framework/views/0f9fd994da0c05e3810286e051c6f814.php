...
<?php $__env->startSection('title', 'จัดการข้อมูลนักศึกษา'); ?>
        ...
        <div class="apple-table-wrap table-responsive">
            <table id="studentsTable" class="table table-hover align-middle" style="width:100%">
                ...
                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-student='<?php echo json_encode($s, 15, 512) ?>' data-id="<?php echo e($s->id); ?>">
                        <td><input type="checkbox" class="row-checkbox row-select" data-id="<?php echo e($s->id); ?>"></td>
                        <td><?php echo e($s->id ?? '-'); ?></td>
                        <td><?php echo e($s->std_id ?? '-'); ?></td>
                        <td><?php echo e(($s->first_name || $s->last_name) ? trim(($s->first_name ?? '') . ' ' . ($s->last_name ?? '')) : '-'); ?></td>
                        <td><?php echo e($s->email ?? '-'); ?></td>
                        <td><?php echo e($s->phone ?? '-'); ?></td>
                        <td>
                            <?php if(!empty($s->photo_id)): ?>
                                <img src="<?php echo e(asset('storage/' . $s->photo_id)); ?>" alt="photo" style="height:40px; width:40px; object-fit:cover; border-radius:6px">
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                        <td>
                            ...
                            <?php if(!empty($atts) && is_array($atts)): ?>
                                <?php $__currentLoopData = $atts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(asset('storage/' . $a)); ?>" target="_blank" class="d-block">ไฟล์</a>
...
$(document).ready(function(){
    ...
    var studentsBaseUrl = '<?php echo e(url('students')); ?>';
    ...
    function openEditModal(student) {
        ...
        if (student.photo_id) {
            $('#currentPhotoPreview').html('<img src="<?php echo e(asset("storage")); ?>/' + student.photo_id + '" style="height:80px; object-fit:cover; border-radius:8px">');
    ...
    $('#saveStudentBtn').on('click', function(e) {
        e.preventDefault();
        var id = $('#id').val();
        var url = '<?php echo e(route("students.store")); ?>';
        if (id) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/student/resources/views/students/index.blade.php ENDPATH**/ ?>