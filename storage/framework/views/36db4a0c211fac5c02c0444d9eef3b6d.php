<?php $__env->startSection('title', 'รายงานนักศึกษาของตนเอง'); ?>
...
<div class="report-container">
    ...
    <div class="stats-grid">
        <div class="stat-card animate-in delay-1">
            ...
            <div class="stat-value"><?php echo e($stats['totalProjects']); ?></div>
        ...
        <div class="stat-card animate-in delay-1">
            ...
            <div class="stat-value"><?php echo e($stats['completedProjects']); ?></div>
        ...
        <div class="stat-card animate-in delay-1">
            ...
            <div class="stat-value"><?php echo e($stats['totalInternships']); ?></div>
        ...
        <div class="stat-card animate-in delay-1">
            ...
            <div class="stat-value"><?php echo e($stats['completedInternships']); ?></div>
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $myProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <strong><?php echo e($project->title ?? 'ไม่มีชื่อ'); ?></strong>
                                </td>
                                <td>
        ...
        <?php if($myInternships->count() > 0): ?>
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $myInternships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $internship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <strong><?php echo e($internship->company_name); ?></strong>
                                </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/student/resources/views/reports/my-student-report.blade.php ENDPATH**/ ?>