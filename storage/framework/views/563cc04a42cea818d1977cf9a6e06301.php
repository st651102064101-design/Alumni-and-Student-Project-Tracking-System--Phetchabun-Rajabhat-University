...
<div class="bg-white rounded-lg shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-700">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-white"><?php echo e(auth()->user()->name ?? 'ผู้ใช้งาน'); ?></h1>
                <p class="text-blue-100"><?php echo e(auth()->user()->email ?? 'ไม่มีอีเมล'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6">
            ...
            <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->name ?? '-'); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm text-gray-600">อีเมล</label>
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->email ?? '-'); ?></p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->updated_at?->format('d M Y, H:i') ?? 'ครั้งแรก'); ?></p>
                    </div>
                </div>
            </div>
        ...
        <!-- ออกจากระบบ -->
        <div class="mt-6">
            <a href="<?php echo e(route('logout')); ?>" class="inline-flex items-center px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/student/resources/views/profile.blade.php ENDPATH**/ ?>