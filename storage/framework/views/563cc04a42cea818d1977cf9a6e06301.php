...
<div class="profile-container">
    ...
    <div class="profile-header animate-in">
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                <h1><?php echo e(auth()->user()->name ?? 'ผู้ใช้งาน'); ?></h1>
                <p><?php echo e(auth()->user()->email ?? 'ไม่มีอีเมล'); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="profile-card animate-in delay-1">
            ...
            <div>
                <div class="profile-info-item">
                    ...
                    <div class="profile-info-value"><?php echo e(auth()->user()->name ?? '-'); ?></div>
                </div>
                <div class="profile-info-item">
                    <div class="profile-info-label">อีเมล</div>
                    <div class="profile-info-value"><?php echo e(auth()->user()->email ?? '-'); ?></div>
                </div>
                <div class="profile-info-item">
                ...
                <div class="profile-info-item">
                    ...
                    <div class="profile-info-value"><?php echo e(auth()->user()->updated_at?->format('d M Y, H:i') ?? 'ครั้งแรก'); ?></div>
                </div>
            </div>
        </div>
    ...
    <div class="profile-card-full animate-in delay-3">
        ...
        <div class="button-group">
            <a href="<?php echo e(route('logout')); ?>" class="apple-btn apple-btn-danger">
                <i class="fas fa-sign-out-alt"></i> ออกจากระบบ
            </a>
        </div>
    </div>
